...
<Playground>
  <Flex justifyContent="space-around">
    <Button icon={<Icon name="alert-circle" />} >Primary Button</Button>
    <Button variant="success" icon={<Icon name="alert-circle" />}>Success Button</Button>
  </Flex>
</Playground>
...
<Playground>
  <Flex justifyContent="space-around">
    ...
    <Button.Group>
      <Button icon={<Icon name="alert-circle" />} />
      <Button outline icon={<Icon name="alert-circle" />} />
    </Button.Group>
  </Flex>
</Playground>
...
<Playground>
  <Flex justifyContent="space-around">
    <Button size="xs">I'm X-Small</Button>
